...
DutyNow dutyFromJson(String str) => DutyNow.fromJson(json.decode(str));

String dutyToJson(DutyNow data) => json.encode(data.toJson());
...
class DutyNow {
  ...
  factory DutyNow.fromJson(Map<String, dynamic> json) => DutyNow(
        dates: json["dates"],
        times: json["times"],
