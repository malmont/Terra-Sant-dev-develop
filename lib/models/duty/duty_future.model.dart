...
DutyFuture dutyFromJson(String str) => DutyFuture.fromJson(json.decode(str));

String dutyToJson(DutyFuture data) => json.encode(data.toJson());
...
class DutyFuture {
  ...
  factory DutyFuture.fromJson(Map<String, dynamic> json) => DutyFuture(
        dates: json["dates"],
        times: json["times"],
